                        ...
                        <!-- Input Field Selection -->
                            <form v-else ref="form">
                                <div class="container-fluid">
                                    ...
                                    <div class="form-group row justify-content-left py-2">
                                        <label class="col-4">Re-enter password</label><div class="col col-8">
                                    ...
                                    <div class="row justify-content-around">
                                        ...
                                        <div type="button" class="btn btn-primaary col-4" @click="register">Register</div>
                                    </div>
                                </div>
                            </form>
                    </div>
...
export default{
    ...
    computed: {
        passwordConfirmationRule(){
            return(this.passsrod === this.repassword) || 'Password must match'
